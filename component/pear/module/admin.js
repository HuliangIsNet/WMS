layui.define(['message', 'table', 'jquery', 'element', 'yaml', 'form', 'tab', 'menu', 'frame', 'theme', 'convert', 'common', 'apis'],
	function (exports) {
		"use strict";
		...
		var pearAdmin = new function () {
			...
			this.logoRender = function (param) {
				...
				$(".layui-logo .title").attr("data-i18n-text", param.logo.title);
			}
			...
			this.menuRender = function (param) {
				...
				}, apis.MenuGetMenuListByUserId, { userId: user.id, menuClientType: user.id == 0 ? null : 0 });
			}
