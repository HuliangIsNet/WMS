...
function getLodop(oOBJECT, oEMBED) {
    ...
    var strCLodopInstallA = "<br><font color='#FF00FF'>Web打印服务CLodop未安装启动，点击这里<a href='/component/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>下载执行安装</a>";
    var strCLodopInstallB = "<br>（若此前已安装过，可<a href='CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）";
    var strCLodopUpdate   = "<br><font color='#FF00FF'>Web打印服务CLodop需升级!点击这里<a href='/component/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行升级</a>";
    ...
    try {
        ...
        LODOP.SET_LICENSES("安徽学舟软件科技有限公司","562049078EE17DEBD1B594BCA683CAFE","","");
        //===============================================================================
        return LODOP;
    } catch (err) {
